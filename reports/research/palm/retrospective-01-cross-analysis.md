...
3. **저다양성 (1-5종, 89명)**: Day 1에 15.7분이었으나, Day 2~3에 48~53분까지 급증한 뒤 Day 5~6에 다시 15분대로 돌아온다(-3.2%). D1 대비 총 변화는 거의 없으나, 중간에 "벌크업"했다가 원위치하는 독특한 패턴이다. 단, 표본이 89명으로 작아 해석에 주의가 필요하다.
